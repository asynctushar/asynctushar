...
I take projects from idea to shipped product. Lately that's meant SaaS dashboards, marketing sites, and internal tools — mostly for clients who care about both performance and polish.

- Frontend dev with React and Next.js
- UI that's clean, intuitive, and mobile-first
...
I'm currently available for frontend-heavy projects — especially if you're building something with React or Next.js and care about getting the UI right.
